...
<img src="images/click.png" alt="click here to surf" height="100" width="100"></div>
	...
	<br><br>
	<br><br>
	<h1><center>Now News Websites is Loaded!<?php echo $_SESSION['usr_name']; ?></center></h1>
	<h5><center>Ready for Breaking News? then Click on Surfit to Discover News Websites</center></h5>
