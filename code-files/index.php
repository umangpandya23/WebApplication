...
<body class="bg-steel">
    <div class="app-bar fixed-top darcula" data-role="appbar">
        <!--<button class="app-bar-element branding" id="btn">Surfit</button>-->
...
<iframe id="frame" src="hello.php" frameborder="0" style="overflow:hidden;overflow-x:hidden;overflow-y:hidden;height:100%;width:100%;position:absolute;top:60px;left:0px;right:0px;bottom:0px" height="100%" width="100%" ></iframe>
<script>
var cat1 = [
